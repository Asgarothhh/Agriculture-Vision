"""HTTP API сервиса сегментации полей."""
...
def _health_payload() -> HealthResponse:
    ...
    if not loaded:
        hint = (
            ...
            "На ML-сервере нет весов моделей (best_iou.pth). "
            "Положите чекпоинт в app/segmentation_service/weights/best_iou.pth"
        )
...
# The public web UI is served by app/api_gateway.
